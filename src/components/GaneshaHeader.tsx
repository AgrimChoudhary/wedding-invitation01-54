      ...
      <div className={cn(
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-10">
          <div className="relative w-32 h-32 md:w-40 md:h-40">
            <div className={cn(
              "absolute inset-0 bg-gold-light/10 rounded-full transition-all duration-700",
              isShimmer && "bg-gold-light/30"
            )}></div>
            
            {/* Ganesha image */}
            <img 
              src="/lovable-uploads/ganesha.png" 
              alt="Lord Ganesha" 
              className={cn(
          ...
          <div className="text-center md:text-left">
            ...
            <div className={cn(
              "gold-text font-cormorant text-lg md:text-xl italic leading-relaxed transition-all",
              isShimmer && "text-gold-light"
            )}>
              <p className="mb-1">वक्रतुण्ड महाकाय सूर्यकोटि समप्रभ ।</p>
              <p>निर्विघ्नं कुरु मे देव सर्वकार्येषु सर्वदा ॥</p>
            </div>
            
            <p className="text-cream/70 text-sm mt-2 md:max-w-xs">
              O Lord Ganesha, with curved trunk, large body, and the brilliance of a million suns,
              please make all my work obstacle-free, always.
            </p>
          </div>
        </div>
      </div>
