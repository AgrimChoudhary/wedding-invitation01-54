...
const Welcome = () => {
  ...
  const [showSangeethModal, setShowSangeethModal] = useState(false);
  const [showHaldiModal, setShowHaldiModal] = useState(false);
  ...
  return (
    <div className="overflow-x-hidden">
      <div className="w-full min-h-screen bg-gradient-to-b from-red-50 to-amber-50 relative overflow-x-hidden">
        <GaneshaHeader />

        <AudioPlayer />
        
        <nav className="sticky top-0 z-50 bg-red-800 shadow-md">
          <div className="container mx-auto px-4 py-2">
            <div className="flex justify-between items-center">
              <div className="text-white font-bold text-lg">Priya & Vijay</div>
              <div className="flex items-center space-x-4">
                <a href="#events" className="text-white hover:text-amber-200 text-sm md:text-base">Events</a>
                <a href="#venue" className="text-white hover:text-amber-200 text-sm md:text-base">Venue</a>
                <Link to="/wishing-wall" className="text-white hover:text-amber-200 text-sm md:text-base">Wishes</Link>
                <button 
                  className="text-white hover:text-amber-200 text-sm md:text-base"
